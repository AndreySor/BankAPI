...
public class CardRepositoryImp implements CardRepository<Card>{
    ...
    public CardRepositoryImp(DataSource dataSource) {
        this.dataSource = dataSource;
    }

    private Card rowMapper(ResultSet resultSet) throws SQLException {
    ...
    public Optional<Card> getByNumber(String cardNumber) throws SQLException {
        try (Connection connection = dataSource.getConnection();
             PreparedStatement statement = connection.prepareStatement(SQL_SELECT_GET_BY_CARD_NUMBER)) {
